...
CUtfField::CUtfField(const UTF_FIELD &tpl) {
    ...
    case ACB_UTF_COLUMN_TYPE_DATA:
        ...
        break;
    case ACB_UTF_COLUMN_TYPE_STRING: {
...
void CUtfField::SetValue(const char *str, std::uint32_t fieldOffset) {
    ...
    offset = fieldOffset;
    type   = ACB_UTF_COLUMN_TYPE_STRING;
}
